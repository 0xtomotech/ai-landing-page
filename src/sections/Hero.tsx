...
export const Hero = () => {
  ...
  //   console.log("scrollYPorgress", latest);
  // });
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="h-[492px] md:h-[800px] overflow-hidden relative flex items-center [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]"
      style={{
